...
- name: DataDog API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/hosts/master/_listings/datadog/tags-hosts-host-name-delete.md
- name: DataDog API Add Tags Hosts Host Name
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/hosts/master/_listings/datadog/tags-hosts-host-name-post.md
x-common:
- type: x-blog
